...
$(function(){
  // Add a click event listener for team member images with data-tab attributes
  $('.team-img[data-tab]').on('click', function(e){
    e.preventDefault();
  ...
  // Add a click event listener for close buttons in pop-up boxes
